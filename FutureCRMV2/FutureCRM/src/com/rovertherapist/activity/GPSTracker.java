...
public class GPSTracker extends Service implements LocationListener {
	...
	public Location getLocation() {
		try {
			...
			if (!isGPSEnabled && !isNetworkEnabled) {
				...
				locmsg = "Location Can not be traced. All Providers are Disabled.";
				locflag = -1;
	...
	private void setPreference(Location location) {
		try {
			...
			editor.commit();
			/*
			 * HashMap params = new HashMap(); params.put("methodId",
			 * "insertUserLocation"); params.put("imei", getIMEI());
			 * params.put("lat", location.getLatitude() + ""); params.put("lng",
			 * location.getLongitude() + ""); String op =
			 * HttpView.getData(params);
			 */
